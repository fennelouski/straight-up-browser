...
extension Notification.Name {
    ...
    static let browserToggleScratchPad = Notification.Name("browserToggleScratchPad")
    ...
    static let sitePermissionsChanged = Notification.Name("sitePermissionsChanged")
