...
struct AgentSettingsView: View {
    ...
    private var availabilitySection: some View {
        CollapsibleSection(searchID: "agent.availability") {
    ...
    private var interfaceSection: some View {
        CollapsibleSection(searchID: "agent.panel") {
    ...
    private var providerSection: some View {
        CollapsibleSection(searchID: "agent.provider") {
    ...
    private var providerPricingSection: some View {
        CollapsibleSection(searchID: "agent.pricing") {
    ...
    private var coworkSection: some View {
        CollapsibleSection(searchID: "agent.cowork") {
    ...
    private var managementSection: some View {
        CollapsibleSection(searchID: "agent.automation-records") {
    ...
    private var safetySection: some View {
        CollapsibleSection(searchID: "agent.safety") {
    ...
    private var delegationSection: some View {
        CollapsibleSection(searchID: "agent.delegation") {
    ...
    private var memorySection: some View {
        CollapsibleSection(searchID: "agent.memory") {
    ...
    private var diagnosticsSection: some View {
        CollapsibleSection(searchID: "agent.diagnostics") {
    ...
    private var syncSection: some View {
        CollapsibleSection(searchID: "agent.sync") {
            Toggle(
